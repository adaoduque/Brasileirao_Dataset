...
function getRodadas( $html ) {
	...
	$html.find('tr').each( function () {
		...
		if( $tds.length == 1 && $tds.attr('bgcolor') == '#008000' ) {
			...
			isContinue = true;
		}else if( $tds.length == 1 && checkClube( $tds.text() ) && ( $tds.attr('bgcolor').toUpperCase() == '#E7E7DC' || $tds.attr('bgcolor').toUpperCase() == '#E1E1D5' || $tds.attr('bgcolor').toUpperCase() == '#DBDBDB' || $tds.attr('bgcolor').toUpperCase() == '#DFDFD2' ) ) {
